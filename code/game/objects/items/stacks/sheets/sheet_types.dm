...
GLOBAL_LIST_INIT(metal_recipes, list(
	new /datum/stack_recipe_list("Строительство", list(
		new /datum/stack_recipe("Напольная плитка", /obj/item/stack/tile/plasteel, 4, 20),
		new /datum/stack_recipe/rods("Металлические стержни", /obj/item/stack/rods, 2, 50),
		new /datum/stack_recipe("Напольная лампа", /obj/item/mounted/frame/light_fixture/floor, 3),
		new /datum/stack_recipe("Машинная каркас", /obj/machinery/constructable_frame/machine_frame, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Компьютерный каркас", /obj/structure/computerframe, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Стена", /obj/structure/girder, 2, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Лестница", /obj/structure/stairs_frame, 15, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Пожарный шлюз", /obj/structure/firelock_frame, 3, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Отражатель", /obj/structure/reflector, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Турель", /obj/machinery/porta_turret_construct, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Мясной крюк", /obj/structure/kitchenspike_frame, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	)),
	new /datum/stack_recipe_list("Настенный", list(
		new /datum/stack_recipe("Локальный контроллер питания", /obj/item/mounted/frame/apc_frame, 2),
		new /datum/stack_recipe("Датчик атмосферы", /obj/item/mounted/frame/alarm_frame, 2),
		new /datum/stack_recipe("Пожарная сигнализация", /obj/item/mounted/frame/firealarm, 2),
		new /datum/stack_recipe("Интерком", /obj/item/mounted/frame/intercom, 2),
		new /datum/stack_recipe("Каркас лампы", /obj/item/mounted/frame/light_fixture, 2),
		new /datum/stack_recipe("Каркас малой лампы", /obj/item/mounted/frame/light_fixture/small),
		new /datum/stack_recipe("Переключатель света", /obj/item/mounted/frame/light_switch),
		new /datum/stack_recipe("Кнопка", /obj/item/mounted/frame/door_control),
		new /datum/stack_recipe("Кнопка масс-драйвера", /obj/item/mounted/frame/driver_button),
		new /datum/stack_recipe("Ящик для огнетушителя", /obj/item/mounted/frame/extinguisher, 2),
		new /datum/stack_recipe("Душ", /obj/item/mounted/shower, 5),
		new /datum/stack_recipe("Держатель факела", /obj/item/mounted/frame/torch_holder, 2),
	)),
	new /datum/stack_recipe_list("Воздушные шлюзы", list(
		new /datum/stack_recipe("Стандартный", /obj/structure/door_assembly, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Публичный", /obj/structure/door_assembly/door_assembly_public, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Командный", /obj/structure/door_assembly/door_assembly_com, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Охрана", /obj/structure/door_assembly/door_assembly_sec, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Инженерный", /obj/structure/door_assembly/door_assembly_eng, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Шахтёрский", /obj/structure/door_assembly/door_assembly_min, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Атмосферный", /obj/structure/door_assembly/door_assembly_atmo, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Исследовательский", /obj/structure/door_assembly/door_assembly_research, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Научный", /obj/structure/door_assembly/door_assembly_science, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Медицинский", /obj/structure/door_assembly/door_assembly_med, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Технический", /obj/structure/door_assembly/door_assembly_mai, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Внешний технический", /obj/structure/door_assembly/door_assembly_extmai, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Внешний", /obj/structure/door_assembly/door_assembly_ext, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Морозильник", /obj/structure/door_assembly/door_assembly_fre, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Герметичный", /obj/structure/door_assembly/door_assembly_hatch, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Технический люк", /obj/structure/door_assembly/door_assembly_mhatch, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Многосекционный", /obj/structure/door_assembly/multi_tile, 8, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	)),
	new /datum/stack_recipe_list("Диваны", list(
		new /datum/stack_recipe("Обычный (центр)", /obj/structure/chair/sofa, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Обычный (левый)", /obj/structure/chair/sofa/left, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Обычный (правый)", /obj/structure/chair/sofa/right, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Обычный (угол)", /obj/structure/chair/sofa/corner, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Корпоративный (центр)", /obj/structure/chair/sofa/corp, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Корпоративный (левый)", /obj/structure/chair/sofa/corp/left, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Корпоративный (правый)", /obj/structure/chair/sofa/corp/right, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Корпоративный (угол)", /obj/structure/chair/sofa/corp/corner, one_per_turf = TRUE, on_floor = TRUE),
	)),
	new /datum/stack_recipe_list("Сиденья", list(
		new /datum/stack_recipe("Стул", /obj/structure/chair, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Тёмное офисное кресло", /obj/structure/chair/office/dark, 1, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Светлое офисное кресло", /obj/structure/chair/office/light, 1, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Тёмное сиденье шаттла", /obj/structure/chair/comfy/shuttle/dark, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Светлое сиденье шаттла", /obj/structure/chair/comfy/shuttle, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Табуретка", /obj/structure/chair/stool, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Барный стул", /obj/structure/chair/stool/bar, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Парикмахерское кресло", /obj/structure/chair/barber, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Инвалидная коляска", /obj/vehicle/ridden/wheelchair, 15, one_per_turf = TRUE, on_floor = TRUE),
	)),
	new /datum/stack_recipe_list("Удобные кресла", list(
		new /datum/stack_recipe("Бежевое", /obj/structure/chair/comfy/beige, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Чёрное", /obj/structure/chair/comfy/black, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Синие", /obj/structure/chair/comfy/blue, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Коричневое", /obj/structure/chair/comfy/brown, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Зеленое", /obj/structure/chair/comfy/green, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Лаймовое", /obj/structure/chair/comfy/lime, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Фиолетовое", /obj/structure/chair/comfy/purp, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Красное", /obj/structure/chair/comfy/red, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Бирюзовое", /obj/structure/chair/comfy/teal, 2, one_per_turf = TRUE, on_floor = TRUE),
	)),
	new /datum/stack_recipe_list("Остальное", list(
		new /datum/stack_recipe("Корпус гранаты", /obj/item/grenade/chem_grenade),
		new /datum/stack_recipe("Шкаф", /obj/structure/closet, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Стойка", /obj/item/rack_parts),
		new /datum/stack_recipe("Оружейная стойка", /obj/item/rack_parts/gunrack_parts),
		new /datum/stack_recipe("Полка для ящиков", /obj/item/rack_parts/cargo_shelf),
		new /datum/stack_recipe("Канистра", /obj/machinery/portable_atmospherics/canister, 10, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Кровать", /obj/structure/bed, 2, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Психиатрическая койка", /obj/structure/bed/psych, 5, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Скамья для жима", /obj/structure/weightmachine/weightlifter, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
		new /datum/stack_recipe("Грузоблочный тренажёр", /obj/structure/weightmachine/stacklifter, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	)),
))
...
GLOBAL_LIST_INIT(plasteel_recipes, list(
	new /datum/stack_recipe("Ящик", /obj/structure/closet/crate, 10, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	new /datum/stack_recipe("Операционный стол", /obj/machinery/optable, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	new /datum/stack_recipe("Высоко защищенный шлюз", /obj/structure/door_assembly/door_assembly_highsecurity, 6, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	new /datum/stack_recipe("Шлюз хранилища", /obj/structure/door_assembly/door_assembly_vault, 8, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	new /datum/stack_recipe("Бомба", /obj/machinery/syndicatebomb/empty, 3, time = 5 SECONDS),
	new /datum/stack_recipe("Ядро ИИ", /obj/structure/AIcore, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
	new /datum/stack_recipe("Масс-драйвер", /obj/machinery/mass_driver_frame, 3, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE),
))
...
GLOBAL_LIST_INIT(cloth_recipes, list(
	new /datum/stack_recipe_list("Рюкзаки", list(
		new /datum/stack_recipe("Рюкзак", /obj/item/storage/backpack, 4),
		new /datum/stack_recipe("Ранец", /obj/item/storage/backpack/satchel_norm, 4),
		new /datum/stack_recipe("Сумка", /obj/item/storage/backpack/duffel, 6),
		new /datum/stack_recipe("Портплед", /obj/item/storage/garmentbag, 8),
	)),
	new /datum/stack_recipe_list("Рабочие сумки", list(
		new /datum/stack_recipe("Экстренная аптечка", /obj/item/storage/firstaid/crew, 4),
		new /datum/stack_recipe("Сумка для химикатов", /obj/item/storage/bag/chemistry, 4),
		new /datum/stack_recipe("Сумка для биоматериалов", /obj/item/storage/bag/bio, 4),
		new /datum/stack_recipe("Сумка для расстений", /obj/item/storage/bag/plants, 4),
		new /datum/stack_recipe("Сумка для рыбы", /obj/item/storage/bag/fish, 4),
		new /datum/stack_recipe("Сумка для драгоценных камней", /obj/item/storage/bag/gem, 4),
		new /datum/stack_recipe("Строительная сумка", /obj/item/storage/bag/construction, 4),
		new /datum/stack_recipe("Шахтёрская сумка", /obj/item/storage/bag/ore, 4),
		new /datum/stack_recipe("Книжная сумка", /obj/item/storage/bag/books, 4),
		new /datum/stack_recipe("Денежный мешок", /obj/item/storage/bag/money, 4),
	)),
	new /datum/stack_recipe_list("Одежда", list(
		new /datum/stack_recipe("Кепка", /obj/item/clothing/head/soft/mime, 2),
		new /datum/stack_recipe("Шапочка", /obj/item/clothing/head/beanie, 2),
		new /datum/stack_recipe("Кросовки", /obj/item/clothing/shoes/color/white, 2),
		new /datum/stack_recipe("Повязки для ног", /obj/item/clothing/shoes/footwraps, 2),
		new /datum/stack_recipe("Комбинезон", /obj/item/clothing/under/color/white, 4),
		new /datum/stack_recipe("Короткое полотенце", /obj/item/clothing/suit/towel/short, 2),
		new /datum/stack_recipe("Короткое полотенце (альт.)", /obj/item/clothing/suit/towel/short/alt, 2),
		new /datum/stack_recipe("Длинное полотенце", /obj/item/clothing/suit/towel, 3),
		new /datum/stack_recipe("Длинное полотенце (альт.)", /obj/item/clothing/suit/towel/alt, 3),
	)),
	new /datum/stack_recipe_list("Аксессуары", list(
		new /datum/stack_recipe("Шарф", /obj/item/clothing/accessory/scarf/white),
		new /datum/stack_recipe("Повязка на глаза", /obj/item/clothing/glasses/sunglasses/blindfold, 2),
		new /datum/stack_recipe("Повязка на глаза (ложная)", /obj/item/clothing/glasses/sunglasses/blindfold_fake),
		new /datum/stack_recipe("Перчатки", /obj/item/clothing/gloves/color/white, 2),
		new /datum/stack_recipe("Перчатки без пальцев", /obj/item/clothing/gloves/fingerless),
	)),
	new /datum/stack_recipe_list("Остальное", list(
		new /datum/stack_recipe("Одеяло", /obj/item/bedsheet, 4),
		new /datum/stack_recipe("Мешок с песком", /obj/item/emptysandbag, 4),
		new /datum/stack_recipe("Плетеная кровать", /obj/structure/bed/wicker, 10, one_per_turf = TRUE, on_floor = TRUE, time = 5 SECONDS),
		new /datum/stack_recipe("Боксерская груша", /obj/structure/punching_bag, 10, one_per_turf = TRUE, on_floor = TRUE, time = 5 SECONDS),
		new /datum/stack_recipe("Марля", /obj/item/stack/medical/bruise_pack/improvised, res_amount = 2, max_res_amount = 6),
		new /datum/stack_recipe("Тряпка", /obj/item/reagent_containers/glass/rag),
	)),
	null,
))
